...
mod doctor_models;
#[path = "doctor_dependency_checks.rs"]
...
mod tests {
    ...
    fn evaluates_component_policies() {
        let missing_mandatory = super::doctor_dependency_checks::evaluate_component(
            "gamescope",
        ...
        let forced_off = super::doctor_dependency_checks::evaluate_component(
            "gamescope",
