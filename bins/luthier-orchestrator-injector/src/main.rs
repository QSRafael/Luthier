...
use anyhow::Context;
use clap::Parser;
use luthier_orchestrator_core::injector::{inject_from_files, InjectOptions};
use luthier_orchestrator_core::observability::{
...
fn log_event(
    ...
    let event = LogEvent::new(
        ...
        code,
        message,
        LogIdentity::new(trace_id, "injector", "unknown", "luthier"),
        context,
    );
