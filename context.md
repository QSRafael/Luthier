...
O historico completo de checkpoints foi movido para um arquivo separado para manter este `context.md` focado na especificacao e nas regras de negocio:

- `docs/context-checkpoints.md`

Regras desta separacao:
- Nenhuma especificacao foi removida desta documentação; apenas o historico de implementacao foi separado.
