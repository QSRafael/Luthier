        ...
        <DialogContent>
          ...
          <div class="grid gap-4 py-4">
            <div class="grid gap-2">
              ...
              <Input
                value={dllDraft().dll}
                class={
                  dllValidation().error ? 'border-destructive focus-visible:ring-destructive' : ''
                }
          ...
          <DialogFooter>
            ...
            <Button
              type="button"
              disabled={
                !dllDraft().dll.trim() || !!dllValidation().error || !!dllDuplicateValidation()
              }
              onClick={() => {
          ...
          <div class="grid gap-4 py-4">
            <div class="grid gap-2">
              ...
              <Select
                ...
                onInput={(e) =>
                  setWineDesktopFolderDraft({
                    ...wineDesktopFolderDraft(),
                    folder_key: e.currentTarget.value,
                  })
                }
              >
            ...
            <div class="grid gap-2">
              ...
              <Show
                when={
                  desktopFolderLinuxPathValidation().error ||
                  desktopFolderLinuxPathValidation().hint
                }
              >
                <p
                  class={
              ...
              onClick={() => {
                ...
                patchConfig((prev) => ({
                  ...
                  winecfg: {
                    ...prev.winecfg,
                    desktop_folders: [
                      ...prev.winecfg.desktop_folders.filter(
                        (f) => f.folder_key !== draft.folder_key
                      ),
                      {
        ...
        <DialogContent>
          ...
          <div class="grid gap-4 py-4">
            <div class="grid grid-cols-2 gap-4">
              <div class="grid gap-2">
                ...
                <Select
                  ...
                  onInput={(e) =>
                    setWineDriveDraft({ ...wineDriveDraft(), letter: e.currentTarget.value })
                  }
                >
              ...
              <div class="grid gap-2">
                ...
                <Select
                  ...
                  onInput={(e) =>
                    setWineDriveDraft({ ...wineDriveDraft(), drive_type: e.currentTarget.value })
                  }
                >
            ...
            <div class="grid gap-2">
              ...
              />
              <Show
                when={wineDriveHostPathValidation().error || wineDriveHostPathValidation().hint}
              >
                <p
                  class={
                    wineDriveHostPathValidation().error
            ...
            <div class="grid gap-2 md:grid-cols-2 mt-2">
              <div class="grid gap-2">
                ...
                <Input
                  ...
                  onInput={(e) =>
                    setWineDriveDraft((prev: any) => ({ ...prev, label: e.currentTarget.value }))
                  }
                />
              </div>
              <div class="grid gap-2">
                ...
                <Input
                  ...
                  onInput={(e) =>
                    setWineDriveDraft((prev: any) => ({ ...prev, serial: e.currentTarget.value }))
                  }
                />
              </div>
            </div>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              onClick={() => {
                ...
                if (
                  config().winecfg.drives.some(
                    (item) => item.letter.trim().toUpperCase() === letter
                  )
                ) {
                ...
                patchConfig((prev) => ({
                  ...
                  winecfg: {
                    ...prev.winecfg,
                    drives: [
                      ...prev.winecfg.drives.filter((d) => d.letter.toUpperCase() !== letter),
                      {
                        letter,
