export const luthierValidationMessagesEnUS = {
  ...
  luthier_validation_relative_path_specific_target:
  ...
  luthier_validation_relative_path_file_expected:
  ...
  luthier_validation_windows_path_invalid_chars:
    'Windows path contains invalid characters.',
  luthier_validation_windows_path_backslash_hint:
  ...
  luthier_validation_linux_path_absolute:
  ...
  luthier_validation_registry_path_invalid_chars:
    'Registry path contains invalid characters.',
  luthier_validation_registry_hive_invalid:
  ...
  luthier_validation_command_linux_expected:
  ...
  luthier_validation_drive_serial_invalid:
  ...
  luthier_validation_duplicate_registry_key:
  ...
  luthier_validation_duplicate_mount_target:
