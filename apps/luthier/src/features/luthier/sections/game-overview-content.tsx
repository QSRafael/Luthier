...
import { FieldShell, TextInputField } from '../../../components/form/FormControls'
        ...
        <div class="grid gap-2">
          <div class="picker-row">
            <Input
              ...
              onInput={(e) => setExePath(e.currentTarget.value)}
            />
        ...
        <div class="icon-preview">
          <div class="icon-box">
            <Show
              ...
              fallback={<span>{ct('luthier_no_extracted_icon')}</span>}
            >
