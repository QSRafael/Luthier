...
import type { GamescopeWindowType, UpscaleMethod } from '../useLuthierController'
import { SwitchChoiceCard, type LuthierPageSectionProps } from '../page-shared'
              ...
              <div class="rounded-md border border-border/60 bg-muted/30 p-3">
                ...
                <div class="mt-3 grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2">
                  <Input
                    ...
                    inputMode="numeric"
                    class={
                      gamescopeGameWidthValidation().error
                  ...
                  <Input
                    ...
                    inputMode="numeric"
                    class={
                      gamescopeGameHeightValidation().error
                        ? 'border-destructive focus-visible:ring-destructive'
                        : ''
                    }
                    onInput={(e) =>
              ...
              <div class="rounded-md border border-border/60 bg-muted/30 p-3">
                ...
                <div class="mt-3 grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2">
                  <Input
                    ...
                    inputMode="numeric"
                    class={
                      gamescopeOutputWidthValidation().error
                        ? 'border-destructive focus-visible:ring-destructive'
                        : ''
                    }
                  ...
                  <Input
                    ...
                    inputMode="numeric"
                    class={
                      gamescopeOutputHeightValidation().error
                        ? 'border-destructive focus-visible:ring-destructive'
                        : ''
                    }
