...
pub use crate::facade::{
    ...
    hash_executable, import_registry_file, list_child_directories, list_directory_entries,
    prepare_hero_image, search_hero_image, test_configuration, winetricks_available,
